...
class ARGearContentView: ARGBottomFunctionBaseView {
    
    let kARGearContentViewClearButtonName = "icDisabled"
    ...
    func setButtons(ratio: ARGMediaRatio) {
        var clearButtonImageName = kARGearContentViewClearButtonName
