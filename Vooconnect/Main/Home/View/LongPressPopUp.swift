...
struct CommentLongPressPopUp: View {
    @Binding var likeImage: String
    @Binding var longPressPopUp: Bool
//    @State var selectedReaction: Reactions?
    @State var selectedReaction: Int?
    ...
    var body: some View {
        ...
        HStack {
            ...
            Button {
                ...
                isLiked = true
                likeVM.commentReactionApi(reactionType: 2, commentId: commentId)
//                likeVM.reelsLikeDataModel.postID = postID
            } label: {
                Image("LikeTwo")
                    .resizable()
            ...
            Button {
                ...
                isLiked = true
                likeVM.commentReactionApi(reactionType: 3, commentId: commentId)
//                likeVM.reelsLikeDataModel.postID = postID
            } label: {
                Image("Love")
                    .resizable()
            ...
            Button {
                ...
                isLiked = true
                likeVM.commentReactionApi(reactionType: 4, commentId: commentId)
//                likeVM.reelsLikeDataModel.postID = postID
            } label: {
                Image("Haha")
                    .resizable()
            ...
            Button {
                ...
                isLiked = true
                likeVM.commentReactionApi(reactionType: 5, commentId: commentId)
//                likeVM.reelsLikeDataModel.postID = postID
            } label: {
                Image("Sad")
                    .resizable()
            ...
            Button {
                ...
                isLiked = true
                likeVM.commentReactionApi(reactionType: 6, commentId: commentId)
//                likeVM.reelsLikeDataModel.postID = postID
            } label: {
                Image("Angry")
                    .resizable()
