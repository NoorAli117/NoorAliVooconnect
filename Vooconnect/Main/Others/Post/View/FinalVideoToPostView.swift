...
//                                    var arr = [(UIImage,CGSize)]()
//                                    self.postModel.contentOverlay.forEach { content in
//                                        var image : UIImage!
//                                        if(content.type == .sticker)
//                                        {
//                                            let view = stickerView(content: content)
//                                            image =  view.asUIImage()
//                                        }else{
//                                            let view = textView(content: content)
//                                            image =  view.asUIImage()
//                                        }
//                                        arr.append((image,content.size))
//                                    }
//                                    print("content overlay: "+arr.count.description)
