...
//            for i in 1..<self.imageCount {
//                if let image = UIImage(named: String(i)) {
//                    images.append(image)
//                }
//            }
            if let gifURL = Bundle.main.url(forResource: "loader", withExtension: "gif") {
...
//                self.loadingAnimationImageView.image = UIImage(named: "vooconnectLogo") 
