...
class Logger {
    //#if DEBUG || STAGING
        ...
        // SUBSYSTEM: "com.skillr.app"
        // CATEGORY: "Lifecycle"

        private let subsystem = Bundle.main.bundleIdentifier ?? "com.skillr.app"
...
//        func fault(_: @autoclosure () -> String, category _: LogCategory) {
//            // Empty body does nothing, logging in release build is disabled.
//        }
//
//        func error(_: @autoclosure () -> String, category _: LogCategory) {
//            // Empty body does nothing, logging in release build is disabled.
//        }
//
//        func info(_: @autoclosure () -> String, category _: LogCategory) {
//            // Empty body does nothing, logging in release build is disabled.
//        }
//
//        func debug(_: @autoclosure () -> String, category _: LogCategory) {
//            // Empty body does nothing, logging in release build is disabled.
//        }
    //#endif // DEBUG
}
